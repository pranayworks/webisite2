        ...
        >
          <div className="overflow-hidden">
            {testimonials.length === 0 ? (
              <div className="py-20 text-center bg-card rounded-2xl border border-dashed border-border group hover:border-accent/40 transition-all">
                <div className="h-12 w-12 rounded-full bg-accent/20 flex items-center justify-center mx-auto mb-4 text-accent">
                   <Star className="h-6 w-6" />
                </div>
                <p className="text-muted-foreground italic max-w-sm mx-auto">
                  Our community stories are being gathered. Be the first to share your journey through the dashboard!
                </p>
              </div>
            ) : (
              <div
